...
<ul>
    <li>
        ...
        $sql = "Select * From orderforseller natural join seller_creates natural join bought_from";
        ...
        if ($result && $statement->rowCount() > 0) { ?>
            ...
            <table>
                ...
                <?php foreach ($result as $row) { ?>
                    <tr>
                        <td><?php
                            $sql = "Select * From orderforseller natural join seller_creates natural join bought_from WHERE growerID = :growerID";
